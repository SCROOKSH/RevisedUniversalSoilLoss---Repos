...
![](img/studyarea.png){width="100%"}</center>
...
## RStudio Preparation: {#sec-required-r-packages .unnumbered}

### Required R Packages: {#packages .unnumbered}
...
### Setting the Coordinate Reference System: {#sec-rstudio-preparation .unnumbered}
...
## Factor 1 - Rainfall Erosivity (R) {#sec-factor-1-method .unnumbered}

### Input Data: {#sec-R-input-data .unnumbered}
...
![](img/r_factor.png){width="100%"}</center>
...
### Input Data: {#sec-ls-input-data .unnumbered}
...
![**Figure 3a**: Digital Elevation Model (DEM) in meters (m), for the Winlaw and Trozzo Creek watersheds. The maximum elevation in the study area is 1,816 m and the minimum is 678 m. The DEM resolution is 1m.](img/dem_1m.png}</center>

![**Figure 3b**: Digital Elevation Model (DEM) in meters (m), for the Winlaw and Trozzo Creek watersheds. The maximum elevation in the study area is 1,816 m and the minimum is 678 m. The DEM resolution is 25m.](img/dem_25m.png}</center>

### Calculating the LS Factor: {#sec-calculating-the-ls-factor .unnumbered}

Calculating the LS factor involves nine steps:

#### Step 1: Slope Raster {#sec-step-1-ls .unnumbered}
...
![**Figure 4a**: Slope raster in degrees, for the Winlaw and Trozzo Creek watersheds. The maximum slope in the study area is 90 degrees and the minimum is 0 degrees. The DEM resolution is 1m.](img/slope_degrees_1m.png}</center>

![**Figure 4b**: Slope raster in degrees, for the Winlaw and Trozzo Creek watersheds. The maximum slope in the study area is 90 degrees and the minimum is 0 degrees. The DEM resolution is 25m.](img/slope_degrees_25m.png}</center>
...
#### Step 2: Beta {#sec-step-2-ls .unnumbered}
...
![**Figure 5a**: Beta for the Winlaw and Trozzo Creek watersheds. The maximum value in the study area is 3.14m and the minimum value is 0.02. The beta resolution is 1m.](img/beta_1m.png}</center>

![**Figure 5b**: Beta for the Winlaw and Trozzo Creek watersheds. The maximum value in the study area is 2.98m and the minimum value is 0. The beta resolution is 25m.](img/beta_25m.png}</center>

#### Step 3: Ratio of Rill to Interrill Erosivity (m) {#sec-step-3-ls .unnumbered}
...
![**Figure 6a**: Ratio of Rill to Interrill Erosivity (m) for the Winlaw and Trozzo Creek watersheds. The maximum value in the study area is 0.76m and the minimum value is 0.02. The resolution is 1m.](img/m_1m.png}</center>

![**Figure 6b**: Ratio of Rill to Interrill Erosivity (m) for the Winlaw and Trozzo Creek watersheds. The maximum value in the study area is 0.76m and the minimum value is 0.02. The resolution is 25m.](img/m_25m.png}</center>

#### Step 4: Aspect Raster {#sec-step-4-ls .unnumbered}
...
![**Figure 7a**: Aspect, in radians, for the Winlaw and Trozzo Creek watersheds. The maximum aspect value in the study area is 6.28 and the minimum value is 0 . The resolution is 1m.](img/aspect_1m.png}</center>

![**Figure 7b**: Aspect, in radians, for the Winlaw and Trozzo Creek watersheds. The maximum aspect value in the study area is 6.28 and the minimum value is 0. The resolution is 25m.](img/aspect_25m.png}</center>

#### Step 5: Contour Width Factor (X) {#sec-step-5-ls .unnumbered}
...
#### Step 6: Specific Contributing Area {#sec-step-6-ls .unnumbered}
...
![**Figure 9a**: Specific contributing area (A), in pixels, for the Winlaw and Trozzo Creek watersheds. The maximum value in the study area is 358,753 pixels and the minimum value is 1 pixel. The resolution is 1m.](img/a_1m_MAX.png}</center>

![**Figure 9a (accompanying histogram):** Specific contributing area (A) for the Winlaw and Trozzo Creek watersheds. Plot showing limits set to 0 - 5000 pixels. Pixel value is 1m.](img/fd8_1m_hist.png}</center>

![**Figure 9b**: Specific contributing area (A) for the Winlaw and Trozzo Creek watersheds. The maximum value in the study area is 118,414 and the minimum value is 25. The resolution is 25m.](img/a_25m.png}</center>

![**Figure 9b (accompanying histogram):** Specific contributing area (A) for the Winlaw and Trozzo Creek watersheds. Plot showing limits set to 0 - 5000 pixels. Pixel value is 25m.](img/FD8_25M_hist.png}</center>
...
![**Figure 10a**: Specific contributing area (A) with a 100m threshold for the Winlaw and Trozzo Creek watersheds. The maximum value in the study area is 100 and the minimum value is 1. The resolution is 1m.](img/a_1m_100m_cap.png}</center>

![**Figure 10a (accompanying histogram)**: Specific contributing area (A) for the Winlaw and Trozzo Creek watersheds with a 100m threshold. Plot showing limits set to 0 - 100 pixels. Pixel value is 1m.](img/A_1m_hist.png}</center>

![**Figure 10b**: Specific contributing area (A) with a 100m threshold for the Winlaw and Trozzo Creek watersheds. The maximum value in the study area is 100 and the minimum value is 25. The resolution is 25m.](img/a_25m_100m_cap.png}</center>

![**Figure 10b (accompanying histogram):** Specific contributing area (A) for the Winlaw and Trozzo Creek watersheds with a 100m threshold. Plot showing limits set to 0 - 100. Pixel value is 25m.](img/A_25m_hist_N.png}</center>

#### Step 7: Length (L) Raster {#sec-step-7-ls .unnumbered}
...
![**Figure 11a**: Length (L) factor for the Winlaw and Trozzo Creek watersheds. The maximum value in the study area is 4.82 and the minimum value is 0.45. The resolution is 1m.](img/l_1m.png}</center>

![**Figure 11a (accompanying histogram):** Length factor (L) for the Winlaw and Trozzo Creek watersheds. Pixel value is 1m.](img/L_1m_hist.png}</center>

![**Figure 11b**: Length (L) factor for the Winlaw and Trozzo Creek watersheds. The maximum value in the study area is 1.1 and the minimum value is 0.85. The resolution is 25m.](img/l_25m.png}</center>

![**Figure 11a (accompanying histogram):** Length factor (L) for the Winlaw and Trozzo Creek watersheds. Pixel value is 25m.](img/L_25m_hist.png}</center>

#### Step 8: Slope (S) Raster {#sec-step-8-ls .unnumbered}
...
![**Figure 12a**: Slope (S) factor for the Winlaw and Trozzo Creek watersheds. The maximum value in the study area is 36.2 and the minimum value is 0. The resolution is 1m.](img/S_1m.png}</center>

![**Figure 12a (accompanying histogram)**: Slope factor (S) for the Winlaw and Trozzo Creek watersheds. Pixel value is 1m.](img/S_1m_hist.png}</center>

![**Figure 12b**: Slope (S) factor for the Winlaw and Trozzo Creek watersheds. The maximum value in the study area is 44.26 and the minimum value is 0. The resolution is 25m.](img/S_25m.png}</center>

![**Figure 13b (accompanying histogram):** Slope factor (S) for the Winlaw and Trozzo Creek watersheds. Pixel value is 25m.](img/S_25m_hist.png}</center>

#### Step 9: LS Factor {#sec-step-9-ls .unnumbered}
...
![**Figure 14a (accompanying histogram)**: Slope Length factor (LS) for the Winlaw and Trozzo Creek watersheds. Pixel value is 1m.](img/LS_1m_hist.png}</center>

![**Figure 14b**: Slope Length (LS) factor for the Winlaw and Trozzo Creek watersheds. The maximum value in the study area is 43 and the minimum value is 0. The resolution is 25m.](img/LS_25m.png}</center>

![**Figure 14b (accompanying histogram):** Slope Length factor (LS) for the Winlaw and Trozzo Creek watersheds. Pixel value is 25m](img/LS_25m_hist.png}</center>

## Factor 3 - Soil Erodibility (K) {#sec-factor-3 .unnumbered}
...
![](img/c_factor_input_vri.png}</center>
...
![](img/c_factor_input_bs.png}</center>
...
![](img/c_factor_input_roads10m.png){</center>

**Figure 19**: Crop/Vegetation and Management Factor (C) Road data for for the study area located in West Kootenay region of southeastern British Columbia. Data sourced from BC [Digital Road Atlas](https://www2.gov.bc.ca/gov/content/data/geographic-data-services/topographic-data/roads) and bufferd to 10m.
