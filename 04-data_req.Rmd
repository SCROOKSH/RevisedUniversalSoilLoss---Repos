...
Soil erosion using the RUSLE requires several data inputs, which fulfill the data needs of each RUSLE factor (refer to section \@ref(factors)). To model soil erosion, the below data sets **must** be supplied.
